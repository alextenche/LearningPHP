            ...
            <form class="navbar-form navbar-right" method="post">
                ...
                <div class="form-group">
                    <input type="email" class="form-control" placeholder="email" name="loginEmail" id="loginEmail"
                           value="
                                <?php if (isset($_POST['loginEmail'])) { echo addslashes($_POST['loginEmail']); } ?>
                            ">
                </div>
                ...
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="password" name="loginPassword"
                           id="loginPassword"
                           value="
                                <?php if (isset($_POST['loginPassword'])) {echo addslashes($_POST['loginPassword']);} ?>
                            ">
                </div>
            ...
            <form class="marginTop" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="your password" name="password"
                           id="password" value="<?php if (isset($_POST['password'])) {
                        echo addslashes($_POST['email']);
                    } ?>">
                </div>
